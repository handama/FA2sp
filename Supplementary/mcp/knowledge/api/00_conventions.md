...
| `12_fa2_extensions.md` | FA2 扩展功能：刷新函数(update_xxx)、界面更新(redraw_window/update_minimap)、快照(create_snapshot/restore)、撤销(save_undo)、脚本刷(running_lua_brush + X/Y 等全局变量)、打开、保存地图 |
