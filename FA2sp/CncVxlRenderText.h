...
extern "C"
{
	...
	__declspec(dllimport) bool __stdcall CncImgPrepareVXLCache(unsigned int nFacing, int F, int L, int H, int fireAngle);
	...
	__declspec(dllimport) void __stdcall CncImgSetLightingSource(float x, float y, float z);
